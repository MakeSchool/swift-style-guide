# Makeschool.com Swift Style Guide

This guide is based of the [Ray Wenderlich Style Guide](https://github.com/raywenderlich/swift-style-guide). Thanks a lot to the team for providing this awesome style guide!
...
In SpriteBuilder projects code connection variables should be declared with forcefully unwrapped types. All code connections should be marked as *weak*:
...
**Not Preferred:**
```swift
var catchContainer: CCSprite?
```

*Rationale:* After `didLoadFromCCB` is called, all code connections are guaranteed to be set up. Using Optionals, code connection variables would need to be checked for *nil* unnecessarily. Further, code connection variables should be weak because the only mark a reference not an ownership of the object they are pointing to.
